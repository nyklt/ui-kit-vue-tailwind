<template>
  <header
    class="bg-gray-100 relative z-10 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3"
  >
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      <div class="px-2 pt-2 pb-4 sm:flex sm:p-0">
        <a
          href="#"
          class="block px-2 py-1 text-black font-semibold rounded hover:bg-primary hover:text-gray-100"
          >List</a
        >
        <a
          href="#"
          class="mt-1 block px-2 py-1 text-black font-semibold rounded hover:bg-primary hover:text-gray-100 sm:mt-0 sm:ml-2"
          >Blog</a
        >
        <a
          href="#"
